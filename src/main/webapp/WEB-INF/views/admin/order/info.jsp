                    ...
                    <form id="orderForm" action="/order/process" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="orderRec" id="orderRec" class="form-control" value="${order.orderRec}">
                            </div>
                            <div class="form-group">
                                <label for="phone">수령인 연락처</label>
                                <input type="text" name="phone" id="phone" class="form-control" placeholder="-없이 입력하세요." value="${order.phone}">
                            </div>
                            <div class="form-group">
